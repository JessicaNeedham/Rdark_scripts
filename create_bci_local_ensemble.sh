...
export TAG=bci_local_ensemble_2pfts_0324
...
fates_paramfile='/global/homes/j/jneedham/BCI_leafmr/param_dir/Ensemble_params_0324/fates_params_bci_ens_${ending}.nc'
